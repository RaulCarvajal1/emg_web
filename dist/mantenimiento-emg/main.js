    ...
    */
    ...
    AddservicioComponent.prototype.getContratos = function () {
        ...
        this.agreementsServices.getContratosActivos().subscribe(function (res) {
            _this.contratos = res.detail;
            if (res.detail.length == 0) {
                _this.alert.alert('No existe ningun contrato dentro del registro, porfavor primero generar un contrato para poder solicitar un servicio. Puedes crear un contrato en menú de Contratos > Nuevo Contrato.');
            }
        }, function (err) {
            console.error(err);
        });
    ...
    AddservicioComponent.prototype.loadContratosId = function () {
        ...
        this.agreementsServices.getContratosActivosByClient(this.empresa).subscribe(function (res) {
            _this.contratos = res.detail;
            if (res.detail.length == 0) {
                _this.alert.alert('No existe ningun contrato dentro del registro con estos parámetros de búsqueda, porfavor primero generar un contrato para poder solicitar un servicio. Puedes crear un contrato en menú de Contratos > Nuevo Contrato.');
            }
        }, function (err) {
            console.error(err);
        });
