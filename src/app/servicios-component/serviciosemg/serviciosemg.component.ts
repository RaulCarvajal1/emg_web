...
@Component({
  selector: 'app-serviciosemg',
  templateUrl: './serviciosemg.component.html',
  styleUrls: ['./serviciosemg.component.css']
})
export class ServiciosemgComponent implements OnInit {
